                ...
                ZStack{
                    VStack(alignment:.trailing,spacing:.zero){
                        VStack(alignment:.trailing,spacing:.zero){
                            ...
                            InputStoptimeTextField(leadingtext: "stoptime", Stoptimetext: $vm.stoptimetext, unittext: "s", TextfieldWidth: Geometrysize.width/8,TextFieldKeyboardTyperawValue: 2)
                        ...
                        InputConfirmButton(Buttondisable: !vm.Valuelegal()){
                            ...
                            if let newkey=vm.Simulationurlstring,
                               Usermodel.manager.get(key: newkey) == nil{
                                let imagekey=Appusermodel.convertsimulationstring(key:vm.Simulationurlstringwithparamater ?? "",mode: .Squarewavegenerator)
